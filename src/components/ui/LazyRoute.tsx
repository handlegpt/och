...
export const LazyGenerationWorkflow = withLazyLoading(() =>
  import('../GenerationWorkflow').then(module => ({ default: module.GenerationWorkflow }))
)

// 懒加载的用户组件
export const LazyUserHistory = withLazyLoading(() =>
  import('../user/UserHistory').then(module => ({ default: module.UserHistory }))
)
export const LazyUserSettings = withLazyLoading(() =>
  import('../user/UserSettings').then(module => ({ default: module.UserSettings }))
)
export const LazyFavoritesManager = withLazyLoading(() =>
  import('../user/FavoritesManager').then(module => ({ default: module.FavoritesManager }))
)
export const LazyDashboardLayout = withLazyLoading(() =>
  import('../user/DashboardLayout').then(module => ({ default: module.DashboardLayout }))
)
export const LazyPrivacyControls = withLazyLoading(() =>
  import('../user/PrivacyControls').then(module => ({ default: module.PrivacyControls }))
)
...
// 懒加载的认证组件
export const LazyAuthModal = withLazyLoading(() =>
  import('../auth/AuthModal').then(module => ({ default: module.AuthModal }))
)
export const LazyLoginPromptModal = withLazyLoading(() =>
  import('../LoginPromptModal').then(module => ({ default: module.LoginPromptModal }))
)
export const LazyMagicLinkModal = withLazyLoading(() =>
  import('../MagicLinkModal').then(module => ({ default: module.MagicLinkModal }))
)
