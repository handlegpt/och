...
import { validateImageFile, validateBase64Image, uploadRateLimiter, type FileValidationResult } from '../utils/security';
    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <div
        ...
        className={`
          ...
          ${currentFileUrl 
            ? 'p-0' 
            : 'p-4 border-2 border-dashed border-[var(--border-primary)]'
          }
          ${hasError 
