  ...
  app: {
    ...
    profile: {
      ...
      favorites: {
        ...
        emptyDescription: 'Start generating works and add them to favorites!',
      },
      privacy: {
        ...
        profileVisibility: {
          ...
          showHistory: 'Show Generation History',
          showHistoryDesc: 'Allow other users to view your generation history',
          showOnlineStatus: 'Show Online Status',
          showOnlineStatusDesc: 'Show whether you are online',
        },
        contentSharing: {
          title: 'Content Sharing Permissions',
          allowMessages: 'Allow Private Messages',
          allowMessagesDesc: 'Allow other users to send you private messages',
        },
        dataCollection: {
          title: 'Data Collection and Analytics',
          allowDataCollection: 'Allow Data Collection',
          allowDataCollectionDesc: 'Allow us to collect usage data to improve our service',
          allowAnalytics: 'Allow Analytics Tracking',
          allowAnalyticsDesc: 'Allow us to analyze your usage behavior to optimize your experience',
          retentionPeriod: 'Data Retention Period (days)',
          retentionPeriodDesc: 'Data older than this period will be automatically deleted',
        },
        dataManagement: {
