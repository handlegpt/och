export default {
  ...
  app: {
    ...
    result: "Result",
          ...
          magicLink: {
            ...
            checkEmail: "We've sent a login link to your email. Please check your inbox and click the link to complete login.",
            emailSentTo: "Sent to",
            close: "Close"
          },
          loginOptions: {
  ...
  transformationSelector: {
    title: "Start Creating!",
    description: "Choose your favorite creative effects and let AI add infinite possibilities to your images. Drag to reorder your most-used effects.",
    descriptionWithResult: "Amazing! Your creation is ready for the next round. Select a new effect to continue this creative journey."
  },
  imageEditor: {
