export default {
  ...
  app: {
    ...
    pricing: {
      ...
      faq: {
        title: '常见问题',
        subtitle: '解答您关于定价和服务的常见问题',
        q1: '如何开始使用？',
        a1: '注册账户后即可获得3次免费生成，无需信用卡。',
        q2: '可以随时取消订阅吗？',
        a2: '是的，您可以随时在账户设置中取消订阅。',
        q3: '支持哪些支付方式？',
        a3: '我们支持信用卡、PayPal等多种支付方式。',
        q4: '有退款政策吗？',
        a4: '我们提供30天无条件退款保证。',
      },
      loginRequired: '请先登录以使用此功能',
  ...
  social: {
    ...
    shareToGallery: {
      ...
      subtitle: '与社区分享您的创作',
      titleLabel: '标题',
      titlePlaceholder: '为您的创作输入标题',
      descriptionLabel: '描述',
      descriptionPlaceholder: '描述您的创作（可选）',
      publicLabel: '设为公开',
      publicDescription: '允许其他人查看和互动您的创作',
      shareButton: '分享到画廊',
      sharing: '分享中...',
      error: '分享失败，请重试。',
      success: '成功分享到画廊！',
    ...
    gallery: {
      ...
      copyLink: '复制链接',
      shareSuccess: '分享成功！',
      publishSuccess: '作品已发布到画廊',
      unpublishSuccess: '作品已从画廊移除',
    },
    comments: {
      title: '评论',
      writeComment: '写评论',
