  ...
  app: {
    ...
    profile: {
      ...
      favorites: {
        ...
        filterVideos: '视频',
        emptyMessage: '暂无收藏',
        emptyDescription: '开始生成作品并添加到收藏吧！',
      },
      privacy: {
        title: '隐私控制',
        ...
        profileVisibility: {
          title: '个人资料可见性',
          showHistory: '显示生成历史',
          showHistoryDesc: '允许其他用户查看您的生成历史',
          showOnlineStatus: '显示在线状态',
          showOnlineStatusDesc: '显示您是否在线',
        },
        contentSharing: {
          title: '内容分享权限',
          allowMessages: '允许私信',
          allowMessagesDesc: '允许其他用户向您发送私信',
        },
        dataCollection: {
          title: '数据收集和分析',
          allowDataCollection: '允许数据收集',
          allowDataCollectionDesc: '允许我们收集使用数据以改善服务',
          allowAnalytics: '允许分析追踪',
          allowAnalyticsDesc: '允许我们分析您的使用行为以优化体验',
          retentionPeriod: '数据保留期限（天）',
          retentionPeriodDesc: '超过此期限的数据将被自动删除',
        },
        dataManagement: {
          title: '💾 数据管理',
          exportData: '导出数据',
