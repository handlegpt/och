...
interface ResultDisplayProps {
  ...
  onShareToGallery?: (imageUrl: string) => void
      ...
      <div className='w-full flex flex-col md:flex-row gap-3 mt-2'>
        {content.imageUrl && (
          <>
            ...
            {onShareToGallery && (
              <ActionButton onClick={() => onShareToGallery(content.imageUrl || '')}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  className='h-5 w-5'
                  viewBox='0 0 20 20'
                  fill='currentColor'
                >
                  <path d='M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3 3 0 000-2.753l4.94-2.47A3 3 0 1015 8z' />
                </svg>
                <span>{t('resultDisplay.actions.shareToGallery')}</span>
              </ActionButton>
            )}
            <ActionButton onClick={() => onUseImageAsInput(content.imageUrl || '')} isPrimary>
              <svg
